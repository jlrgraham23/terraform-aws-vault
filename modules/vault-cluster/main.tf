...
resource "aws_launch_configuration" "launch_configuration" {
  ...
  metadata_options {
    http_endpoint               = var.launch_configuration_metadata_http_endpoint
    http_tokens                 = var.launch_configuration_metadata_http_tokens
    http_put_response_hop_limit = var.launch_configuration_metadata_http_put_response_hop_limit
  }
